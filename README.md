...
Hard-refresh: [`?v=cns4sense`](https://wjb000.github.io/fruitflybrain/?v=cns4sense). Optional labs stay as links: [follow me](web/follow.html?v=follow1) · [hΔ learning](web/hdelta.html?v=lab1) · [stim map](web/index.html?stim=1&v=cns4sense).
...
python serve.py            # opens http://127.0.0.1:8787/?v=cns4sense
```
...
**Stim map:** `?stim=1&v=cns4sense` — gentle Hz inject through the LIF onto named pools. Not surgery; not a chassis cheat.

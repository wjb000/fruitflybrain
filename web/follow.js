...
import { createDroneChassis } from "./chassis.js?v=cns2";
import { createOpenWorld } from "./world/procgen.js?v=cns2";
import { EmbodiedFly } from "./agent.js?v=cns2";
import { portableControls, droneSetpoints } from "./controller/portable.js?v=cns2";
import { createHandCam, applyCamToFly } from "./handcam.js?v=cns2";

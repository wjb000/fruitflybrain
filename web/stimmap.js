 ...
 */
import { portableControls, chassisSetpoints, droneSetpoints } from "./controller/portable.js?v=cns4sense";
import { STIM_MAP_POOLS, DEFAULT_STIM_HZ } from "./agent.js?v=cns4sense";
...
export function stimMapUrl(on = true) {
  ...
  u.searchParams.set("v", "cns4sense");

...
Main sim (fly utopia default): `index.html?v=linked1` (optional `?cam=1` thumbnail, same encoding). Follow-me stays on the drone chassis. Cube: `?body=cube`. Drone homepage: `index.html?body=drone&v=linked1`.

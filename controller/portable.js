...
Cache-bust ?v=realfly3. Follow-me (optional): follow.html?v=follow1. hΔ lab: hdelta.html?v=lab1. Default home: fly utopia garden. Synaptic efficacy varies over time (STD + connectome weights).
`.trim();
